        ...
        if (text && !filtering) {
            ...
            const newData = items.filter(function (item) {
                ...
                return (
                    ...
                    (activity.indexOf(textData) > -1 &&
                        activity.indexOf(textData) < 2)
                );
            });
            setItems(newData);
            setSearchQuery(text);
                ...
                renderItem={({ item, index }) => {
                    return (
                        ...
                        >
                            ...
                            <Animated.View
                                style={[styles.listComponent, styles.shadow]}
                            >
                                <View flex={1}>
