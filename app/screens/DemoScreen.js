...
function DemoScreen({ navigation, route }) {
    ...
    //Navigate to either CategoryDrop or PatientDashboard if it is the first log in
    const navigate = () => {
            ...
            pages={[
                {
                    ...
                    subtitle:
                        "Select the category you are least interested in to be dropped from the therapy questions",
                ...
                },
                {
                    ...
                    subtitle:
                        "Select a date and time for your therapy sessions to be reminded using notifications",
                },
                {
                    backgroundColor: "#fff",
                    image: (
                    ...
                    subtitle:
                        "Read the scenarios and answer the questions. Click the text to speech button to read the scenario aloud.",
                },
                {
                    backgroundColor: "#fff",
                    image: (
                    ...
                    title: "Take a break",
                    subtitle:
                        'You can take a break in between your therapy questions by clicking the "Take a break" button at the top of your therapy screen.',
                },
                {
                    backgroundColor: "#fff",
                    image: (
                    ...
                    subtitle:
                        "Water your plant with coins you have earned by logging your feelings and completing your therapy sessions. ",
                },
            ]}
        />
    );
