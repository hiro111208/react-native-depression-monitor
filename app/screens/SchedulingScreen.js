        ...
        if (scheduleArr.length === 0) {
            Alert.alert(
                ...
                [
                    {
                        text: "OK",
                        onPress: async () => await this.onFirstAppointment(),
                    },
                    {
                        text: "Cancel",
            ...
            <View style={[indexStyles.containerWhite, indexStyles.centering]}>
                ...
                >
                        ...
                        <View style={{ height: "10%", flexDirection: "row" }}>
                            ...
                            >
                                <DateTimePicker
                                    ...
                                    } // to prevent user to select past date
                                    is24Hour={true}
                                    display="default"
                                    onChange={this.onChange}
                                />
                    ...
                    <View style={[{ height: "10%" }, indexStyles.centering]}>
                        ...
                        >
                            <Text
                                style={[indexStyles.textGrey, { fontSize: 18 }]}
                            >
                                Add Session
                            </Text>
                        </TouchableOpacity>
                    ...
                    <View style={[{ height: "25%" }, indexStyles.centering]}>
                        <View
                            style={[indexStyles.cover, indexStyles.centering]}
                        >
                            <Image
                    ...
                    <View style={[{ height: "10%" }, indexStyles.centering]}>
                        ...
                        >
                            <Text
                                style={[indexStyles.textGrey, { fontSize: 15 }]}
                            >
                                Schedule List
                            </Text>
                        </TouchableOpacity>
