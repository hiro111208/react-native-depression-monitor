                ...
                scheduleInactiveNotification1 = async () => {
                    let notificationId =
                        Notifications.scheduleLocalNotificationAsync(
                            {
                                title: "HUG",
                                body: "It’s been so long since we last saw you that HUG has webs everywhere. Come back and kick the spiders out.",
                            },
                            {
                                time: Date().now,
                            }
                ...
                scheduleInactiveNotification2 = async () => {
                    let notificationId =
                        Notifications.scheduleLocalNotificationAsync(
                            {
                                title: "HUG",
                                body: "We would like to apologize for our developer Chad, who has been sending push notifications to people with better answers than him. Come back to make Chad more angry.",
                            },
                            {
                                time: Date().now,
                            }
                ...
                scheduleInactiveNotification3 = async () => {
                    let notificationId =
                        Notifications.scheduleLocalNotificationAsync(
                            {
                                title: "HUG",
                                body: "Your plant has not seen you in a long time. Come back to give her company and finish your questions.",
                            },
                            {
                                time: Date().now,
                            }
                ...
                scheduleInactiveNotification4 = async () => {
                    let notificationId =
                        Notifications.scheduleLocalNotificationAsync(
                            {
                                title: "HUG",
                                body: "Congratulation you have done more than 75% of the question. Would you like to finish them now?",
                            },
                            {
                                time: Date().now,
                            }
    ...
    render() {
        ...
        return (
            <View style={[styles.container, styles.centering]}>
                <View
                    style={[styles.center, styles.cover, styles.shadowEffect]}
                >
                    <View>
                            ...
                            return (
                                ...
                                >
                                    ...
                                    <TouchableOpacity
                                        ...
                                        onPress={() =>
                                            this.openTwoButtonAlert(item.key)
                                        }
                                    >
                                        <Text>Delete</Text>
                                    </TouchableOpacity>
